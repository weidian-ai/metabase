    ...
    render() {
        ...
        return (
            <div style={{maxWidth: "600px"}}>
                <div className="p2">
                    <div className="h5 text-uppercase text-grey-3 text-bold">{getHTML("EXPRESSION_WIDGET_FORMULA",{defaultValue:"Field formula"})}</div>
                    <div>
                        ...
                        <p className="h5 text-grey-2">
                            {getHTML("EXPRESSION_WIDGET_FORMULA_NOTE", {defaultValue:"Think of this as being kind of like writing a formula in a spreadsheet program: you can use numbers, fields in this table, mathematical symbols like +, and some functions.  So you could type, Subtotal - Cost."})}
                    ...
                    <div className="mt3 h5 text-uppercase text-grey-3 text-bold">{getHTML("EXPRESSION_WIDGET_FORMULA_NAME",{defaultValue:"Give it a name"})}</div>
                    <div>
                        <input
