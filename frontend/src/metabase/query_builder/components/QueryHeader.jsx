...
export default class QueryHeader extends Component {
    constructor(props, context) {
        ...
        this.hasPermission = props.user && (props.user['is_superuser'] || props.user['id'] === props.card['creator_id'])
        this.state = {
            recentlySaved: null,
            modal: null,
            revisions: null
    ...
    getHeaderButtons() {
        ...
        if (!isNew && card.can_write && this.hasPermission) {
            if (!isEditing) {
                ...
                <HeaderBar
                    ...
                    badge={this.props.card.collection &&
                        <Link
                            ...
                            style={{ color: this.props.card.collection.color, fontSize: 12, float: 'left'  }}
                        >
