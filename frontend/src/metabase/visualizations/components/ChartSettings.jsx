...
class ChartSettings extends Component {
    ...
    getChartTypeName() {
        ...
        switch (CardVisualization.identifier) {
            case "table": return getHTML("CHART_SETTING_TBALE", {defaultValue:"table"});
            case "scalar": return getHTML("CHART_SETTING_NUMBER", {defaultValue:"number"});
            case "funnel": return getHTML("CHART_SETTING_FUNNEL", {defaultValue:"funnel"});
            default: return getHTML("CHART_SETTING_CHART", {defaultValue:"chart"});
        }
    }
    ...
    render () {
        ...
        return (
            <div className="flex flex-column spread p4">
                <h2 className="my2">{getHTML("CHART_SETTING_CUSTOMIZE",{defaultValue:"Customize this"})} {this.getChartTypeName()}</h2>
