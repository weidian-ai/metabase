...
import {get} from "metabase/lib/intl";
...
const QUERY_BUILDER_STEPS =  (content) => [
    {
    ...
    {
        getPortalTarget: () => qs(".GuiBuilder-data"),
        getPageFlagTarget: () => qsWithContent(".List-section-header", content["Sample Dataset"]),
        shouldAllowEvent: (e) => qsWithContent(".List-section-header", content["Sample Dataset"]).contains(e.target),
        optional: true
    },
    {
        getPortalTarget: () => qs(".GuiBuilder-data"),
        getPageFlagTarget: () => qsWithContent(".List-item", content["Orders"]),
        shouldAllowEvent: (e) => qsWithContent(".List-item > a", content["Orders"]).contains(e.target)
    },
    {
    ...
    {
        getPortalTarget: () => qs(".GuiBuilder-filtered-by"),
        getPageFlagTarget: () => qsWithContent(".List-item", content["Created At"]),
        shouldAllowEvent: (e) => qsWithContent(".List-item > a", content["Created At"]).contains(e.target)
    },
    {
        getPortalTarget: () => qs(".GuiBuilder-filtered-by"),
    ...
    {
        getPortalTarget: () => qs(".Query-section-breakout"),
        getPageFlagTarget: () => qsWithContent(".List-item", content["Week"]),
        shouldAllowEvent: (e) => qsWithContent(".List-item > a", content["Week"]).contains(e.target)
    },
    {
    ...
    {
        getPortalTarget: () => qs(".VisualizationSettings"),
        getPageFlagTarget: () => qsWithContent(".ChartType-popover li", content["Line"]),
        shouldAllowEvent: (e) => qsWithContent(".ChartType-popover li", content["Line"]).contains(e.target)
    },
    {
...
export default class QueryBuilderTutorial extends Component {
    ...
    render() {
        return <Tutorial steps={QUERY_BUILDER_STEPS(translations)} {...this.props} />;
    }
}
