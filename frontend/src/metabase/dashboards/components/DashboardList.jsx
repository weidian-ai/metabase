...
export class DashboardListItem extends Component {
    ...
    render() {
        ...
        const {id, name, created_at, archived, favorite, creator,creator_id} = dashboard
                    ...
                    <div className={"flex-full shrink-below-content-size"}>
                        <div className="flex align-center">
                            <div className={"flex-full shrink-below-content-size"}>
                                ...
                                <div
                                    className={"text-smaller text-bold text-grey-3 text-ellipsis text-nowrap overflow-hidden"}>
                            ...
                            <div className="flex align-center absolute right transition-all"
                                ...
                                { user && (user['is_superuser'] || user['id'] === creator_id) && archivalButton }
                                { favoritingButton }
                            </div>
...
class DashboardList extends Component {
    ...
    render() {
        const {dashboards, isArchivePage, setFavorited, setArchived, section} = this.props;
        const favoritedDashboards = dashboards.filter((dashboard) => dashboard['favorite']);
        ...
        return (
            <div>
                {
                    favoritedDashboards.length > 0 && section && section['id'] != fileName && <div>
                        <div className="flex align-center pt4 pb1">
                            <h2 className="mr1" style={style}>Favorite</h2>
                        </div>
                        <ol className="Grid Grid--guttersXl Grid--full small-Grid--1of2 md-Grid--1of3">
                            { favoritedDashboards.map(dash =>
                ...
                {
                    section['id'] != fileName && <div className="flex align-center pt4 pb1">
                        <h2 className="mr1" style={style}>All Dashboards</h2>
                    </div>
                }
                <ol className="Grid Grid--guttersXl Grid--full small-Grid--1of2 md-Grid--1of3">
                    { dashboards.map(dash =>
