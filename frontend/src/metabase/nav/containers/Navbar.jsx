        ...
        return (
            <nav className={cx("Nav relative bg-brand sm-py2 sm-py1 xl-py3", this.props.className)}>
                <ul className="ml2 sm-pl4 pr1 flex align-center">
                    ...
                    <li className="pl3 hide xs-show" data-buried="true" data-ec="Dashboards" data-ea="顶部导航">
                        <MainNavLink to="/dashboards" name="Dashboards" eventName="Dashboards" />
                    </li>
                    <li className="pl1 hide xs-show" data-buried="true" data-ec="Questions" data-ea="顶部导航">
                        <MainNavLink to="/questions" name="Questions" eventName="Questions" />
                    </li>
                    <li className="pl1 hide sm-show" data-buried="true" data-ec="Pulses" data-ea="顶部导航">
                        <MainNavLink to="/pulse" name="Pulses" eventName="Pulses" />
                    </li>
                    <li className="pl1 hide sm-show" data-buried="true" data-ec="Data Reference" data-ea="顶部导航">
                        <MainNavLink to="/reference/guide" name="Data Reference" eventName="DataReference" />
                    </li>
                    {/* <li className="pl1 hide sm-show" data-buried="true" data-ec="Data Stream" data-ea="顶部导航">
                        <MainNavLink to="/streams" name="Data Stream" eventName="DataStream" />
                    </li> */}
                    {/* <li className="pl1 hide sm-show" data-buried="true" data-ec="Common Query" data-ea="顶部导航">
                        <MainNavLink to="/queries" name="Common Query" eventName="CommonQuery" />
                    </li> */}
                    <li className="pl3 hide sm-show" data-buried="true" data-ec="New Questions" data-ea="顶部导航">
